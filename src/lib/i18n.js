...
export const strings = {
  hr: {
    ...
    hardModeOn:       'Teški način 🔥 uključen — množitelji 11–99',
    hardModeOff:      'Teški način 🔥 (uključuje množitelje 11–99)',
  ...
  en: {
    ...
    hardModeOn:       'Hard mode 🔥 on — multipliers 11–99',
    hardModeOff:      'Hard mode 🔥 (includes multipliers 11–99)',
